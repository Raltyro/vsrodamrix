...
class AudioBuffer
{
	...
	@:noCompletion private var __references:Array<AudioSource>;
	...
	public function initBuffer():Void {
		if (__references == null) __references = [];
		#if lime_cffi
		__format = 0;
		if (channels == 1) {
	...
	{
		if (__references != null) for (source in __references) if (source != null) source.dispose();
		__references = null;
		#if lime_howlerjs
